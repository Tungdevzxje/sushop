...
<h1 style="font-size:0px; margin: 0px; height:0px; color:#fff; margin: 0px; padding: 0px;"><a>thiết kế kho lạnh bảo quản thực phẩm</a></h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                $id = $_GET['url'];
                $tv = "select * from gioithieu where linkurl like '%" . $id . "%' order by id ";
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="vaytragop-danang">Tin tức &nbsp;/&nbsp;</a></li>
                    <li><?php echo "$ten" ?></li>
                </ul>
            </div>
        </div>
...
<section class="blog blog-section bg-white">
    ...
    margin-bottom: 12px;'>
                    ...
                    $tv = "SELECT * FROM (SELECT * FROM tin_dichvu  ORDER BY id DESC LIMIT 1, 100) as recent_news ORDER BY RAND() LIMIT 1";
                    $tv_1 = mysqli_query($link, $tv);
                    $a_tv_1 = mysqli_query($link, $tv);
                    ?>
                    <?php
                    ...
                    ?>
                        <div class="author_name">
                            <h3 style="font-size: 17px; line-height: 27px; margin-bottom: 0px; display: inline-flex; align-items: center;">
                                <a href="<?php echo $link; ?>" style="display: inline-flex; align-items: center;">
                                    <img src="hinhmenu/snowflake.gif" alt="Cột bê tông ly tâm chất lượng cao" width="40" height="40" style="margin-top: -10px;">
                                    <?php echo $tieude_en; ?>
                                </a>
                            </h3>
                        </div>
    ...
    margin-bottom: 12px;'>
                    ...
                    ?>
                        <div class="author_name">
                            <h3 style="font-size: 17px; line-height: 27px; margin-bottom: 0px; display: inline-flex; align-items: center;">
                                <a href="<?php echo $link; ?>" style="display: inline-flex; align-items: center;">
                                    <img src="hinhmenu/snowflake.gif" alt="Cột bê tông ly tâm chịu lực tốt" width="40" height="40" style="margin-top: -10px;">
                                    <?php echo $tieude_en; ?>
                                </a>
                            </h3>
                        </div>
    ...
    padding-left: 5px;"><i class="fa fa-bars" style="padding-right:10px;"></i> TIN LIÊN QUAN </div>
                    ...
                    <div class="row">
                        ...
                        $pages = $p->findPages($count, $limit);
                        $sql = mysqli_query($link, "SELECT * FROM (SELECT * FROM tin_tintuc WHERE thuocloai = $thuocloai ORDER BY id DESC LIMIT 100) AS latest_20 ORDER BY RAND() LIMIT 9");
                        // Error handling
                        if (!$sql) {
