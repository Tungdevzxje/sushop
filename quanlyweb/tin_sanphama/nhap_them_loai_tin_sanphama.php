...
function upload($thuocloai, $thuocloai_en)
 {
   ...
   $truyvan = " INSERT INTO `loai_tin_sanphama` (`id`, `thuocloai`, `thuocloai_en`) VALUES (NULL, '$thuocloai', '$thuocloai_en')";
...
function xoataptin($tentaptin)
 {
   $ketnoi_maychu = ketnoi_MC();
	...
	$truyvan = "DELETE FROM tin_sanphama WHERE id = $masotaptin ";
	$ketqua_truyvan = truyvan($truyvan,$ketnoi_maychu);
 }
?></td>
    <td valign="top"><p><br />
