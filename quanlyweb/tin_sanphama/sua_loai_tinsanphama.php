...
<table width="780" height="193" border="1" bordercolor="#0000FF" style="border-collapse:collapse">
  ...
  <tr>
    <td width="419" height="22"><div align="center"><strong>Thông Báo </strong></div></td>
    <td width="445"><div align="center"><strong>Hướng Dẫn </strong></div></td>
  </tr>
  <tr>
...
function upload($thuocloai,$thuocloai_en, $id)
 {
   ...
   $truyvan = "update  loai_tin_sanphama set `thuocloai` = '$thuocloai' , `thuocloai_en` = '$thuocloai_en' where id='$id'";
...
?></td>
  ...
  <tr>
   ...
   include('db.php');
   $id=$_REQUEST["id"];
   $result=mysql_query("SELECT * FROM loai_tin_sanphama where id like '$id' ");
   ...
   <form action='' method='post' enctype='multipart/form-data' name='tt_mh' class="style5" id='tt_mh'  onsubmit='return checkInput();'>
      <table width='780' border='1' bordercolor='black' style='border-collapse:collapse'> 
        ...
        <tr>
          <td width="239"><div align="left"><strong>Nhập loại tin tức </strong></div></td>
        ...
        <tr>
          <td><div align="left"><strong>Nhập loại tin tức en</strong></div></td>
          <td><div align="left">
