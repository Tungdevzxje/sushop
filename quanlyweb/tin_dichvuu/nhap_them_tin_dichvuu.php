      ...
      <div class="content">
        ...
        <div class="row">
          ...
          if (isset($_POST['luu'])) {
            ...
            echo "<script>window.location='quan_tri.php?p=ds_tin_dichvuu&page=" . $page . "'</script>";
            exit;
          }
          ...
          function upload($noidung, $tentaptin, $tieude, $mota, $trangchu, $thuocloai, $tieude_en, $title, $tukhoa, $tukhoa2, $ngay, $linkurl)
          {
            ...
            $truyvan = "INSERT INTO tin_dichvuu (`hinhanh`,`hinhndab`,`noidung`,`trangchu`,`mota`,`tieude`, `tieude_en`, `title`, `tukhoa`,`tukhoa2`,`ngay`,`linkurl`,`thuocloai`,`moi`) VALUES ( '$tentaptin','', '$noidung', '$trangchu', '$mota','$tieude', '$tieude_en', '$title', '$tukhoa','$tukhoa2','$ngay', '$linkurl','$thuocloai','0')";
