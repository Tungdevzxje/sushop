    ...
    <div class="content">
      ...
      <div class="row">
        ...
        if (isset($_POST['luu'])) {
          ...
          echo "<script>window.location='quan_tri.php?p=danhsach_loai_tindichvu" . $_GET["page"] . "'</script>";

        }
        function upload($thuocloai, $thuocloai_en, $tentaptin, $url)
        {
          require('db.php');
          $truyvan = " INSERT INTO loai_tin_dichvu (thuocloai,thuocloai_en,trangchu,hinhanh,logo,noidung,noidung_en,name_url) VALUES ('" . $thuocloai . "', '" . $thuocloai_en . "','0','" . $tentaptin . "','','','','" . $url . "')";
        ...
        function xoataptin($tentaptin)
        {
          ...
          $truyvan = "DELETE FROM loai_tin_dichvu WHERE hinhanh = '$tentaptin'";
                  ...
                  <div class="ec-vendor-upload-detail">
                    <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
                      <div class="col-md-7">
                        ...
                        <input name="thuocloai" type="text" id="tieude2" size="60" maxlength="70" />
                      </div>
                      <div class="col-md-12">
