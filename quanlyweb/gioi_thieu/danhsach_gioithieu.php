					...
					<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
						<div>
							...
							<p class="breadcrumbs"><span><a href="index.html">Trang chủ</a></span>
								...
								<span><i class="mdi mdi-chevron-right"></i></span>Danh sách giới thiệu
							</p>
						</div>
					</div>
					<div class="row">
							...
							function pageList($curpage, $pages)
							{
								...
								if ($curpage != 1 && $curpage) {
									$page_list .=
										"<a href=\"" .
										$_SERVER["PHP_SELF"] .
										"?p=danhsach_gioithieu&page=1\" title=\"Trang đầu\"> << </a>";
								}
						...
						$result = mysqli_query($link, "SELECT * FROM gioi_thieu ORDER BY id DESC limit $start,$limit");
						$stt = 1;
						?>
										...
										<table id="responsive-data-table" class="table" style="width:100%">
											...
											<tbody class="text-center">
												...
												while ($row = mysqli_fetch_object($result)) {
													...
													$did = $row->thuocloai;
													$sql3 = mysqli_query($link, "select * from gioi_thieu where id='" . $did . "'");
													...
													<tr>
														...
														<td>
															<a href="quan_tri.php?p=xoa_gioithieu&id=<?= $id ?>"
														...
														<td>
															<a
																href="quan_tri.php?p=sua_gioithieu&id=<?= $id ?>&thuocloai=1&page=<?= $_GET['page'] ?>">
