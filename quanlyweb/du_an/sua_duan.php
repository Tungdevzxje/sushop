          ...
          <table width='780' border='1' bordercolor='black' style='border-collapse:collapse'>
              ...
              <td>
                ...
                <div align="left">
                  ...
                  <label>
                    ...
                    <input name="tieude" type="text" id="masp2" value="<?php echo "$tieude"; ?>" size="60" maxlength="70" />
            ...
            <tr>
              ...
              <td>
                <div align="left">
                  <label></label>
                  <textarea name="mota" cols="60" rows="5" id="mota"><?php echo "$mota"; ?></textarea>
                </div>
              </td>
            </tr>
              ...
              <td>
                ...
                <div align="left">
                  ...
                  <label>
                    ...
                    <input name="tieude_en" type="text" id="masp2" value="<?php echo "$tieude_en"; ?>" size="60" maxlength="70" />
