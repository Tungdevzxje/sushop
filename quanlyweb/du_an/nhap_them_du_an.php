  ...
  <table width="780" height="297" border="1" style="border-collapse:collapse">
	...
	if($today2=='Sun')
		...
		$thu='Chủ Nhật';*/
          ...
          upload($tentaptin, $tieude, $tieude_en, $mota, $noidung);
        }



        function upload($tentaptin, $tieude, $tieude_en, $mota, $noidung)

        {
          ...
          $truyvan = "INSERT INTO du_an (hinhanh,tieude,tieude_en,mota,noidung) VALUES ('" . $tentaptin . "','" . $tieude . "','" . $tieude_en . "', '" . $mota . "','" . $noidung . "')";
...

        {
          ...
          $tv = "select * from loai_du_an where phanloai like '1' ORDER BY id ASC";
            ...
            <tr>
             ...
             <tr>
              ...
              <td>
                ...
                <div align="left"><strong>Chức vụ</strong> </div>
              ...
              <td>
                ...
                <div align="left">
                  ...
                  <label>
                    ...
                    <input name="tieude_en" type="text" id="tieude_en" size="90" maxlength="150" />
