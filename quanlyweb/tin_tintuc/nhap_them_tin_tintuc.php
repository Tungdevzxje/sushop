        ...
        <div class="content">
          ...
          <div class="row">
            ...
            if (isset($_POST['luu'])) {
              ...
              upload($noidung, $noidung_en, $tentaptin, $tieude, $mota, $trangchu, $thuocloai, $tieude_en, $title, $tukhoa, $tukhoa2, $ngay, $linkurl);
              $page = isset($_GET["page"]) ? $_GET["page"] : 1;
              echo "<script>window.location='quan_tri.php?p=ds_tin_tintuc&page=" . $page . "'</script>";
              exit;
            }

            function upload($noidung, $noidung_en, $tentaptin, $tieude, $mota, $trangchu, $thuocloai, $tieude_en, $title, $tukhoa, $tukhoa2, $ngay, $linkurl)
            {
              require('db.php');

              // Xử lý đặc biệt với ký tự trong câu truy vấn
              $truyvan = "INSERT INTO tin_tintuc (`hinhanh`,`hinhndab`,`noidung`, `noidung_en`, `trangchu`,`mota`,`tieude`, `tieude_en`, `title`, `tukhoa`,`tukhoa2`,`ngay`,`linkurl`,`thuocloai`,`moi`) VALUES ( '$tentaptin','', '$noidung', '$noidung_en', '$trangchu', '$mota','$tieude', '$tieude_en', '$title', '$tukhoa','$tukhoa2','$ngay', '$linkurl','$thuocloai','0')";
