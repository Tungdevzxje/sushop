        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="dichvucongty">Dịch vụ &nbsp;/&nbsp;</a></li>
                    <li><?php echo "$ten" ?></li>
                </ul>
            </div>
        </div>
...
<!-- Page title end -->
    ...
    margin-bottom: 12px;'>
                    ...
                    ?>
                        <div style="padding: 10px;margin: 2px;font-size: 17px;font-weight: 300;" >
                            <img src="hinhmenu/me-rev.gif" alt="<?php echo "$tieude"; ?>" style="  margin-top:0px;width: 30px;padding-right: 10px; float: left;" />
                       <div class="author_name"> 
                            <h3 style="font-size: 17px; font-weight: 400; line-height:27px;" class="author_name"><a href="<?php echo "$link"; ?>"><?php echo "$tieude_en"; ?></a></h3>
                              </div>
                        </div>
 ...
 <div class="share-linknd clearfix " style=' margin-top: 5px;
    margin-bottom: 12px;'>
        ...
        require('db.php');
        //$tv = "select * from tin_tintuc order by id desc limit 0,1";
          $tv = "SELECT * FROM (SELECT * FROM tin_tintuc ORDER BY id asc LIMIT 1, 100) as recent_news ORDER BY RAND() LIMIT 1";
         $tv_1 = mysqli_query($link, $tv);
                    $a_tv_1 = mysqli_query($link, $tv);
        ?>
        <?php
    ...
    margin: 2px;
    font-size: 17px;
    font-weight: 300;"><img src="hinhmenu/me-rev.gif" alt="<?php echo "$tieude";?>" style="float: left;  margin-top: 0px;
    width: 30px;
    padding-right: 10px;" />  <h3 style="font-size: 17px; font-weight: 400; line-height:27px;"><a href="<?php echo "$link"; ?>"><?php echo "$tieude_en"; ?></a></h3> </div>
    ...
    font-weight: 800;
      text-transform: none;
    padding: 10px;"><a href="<?php echo $link; ?>" style="line-height:26px;"><?php echo $tieude_en; ?> </a></h2>
    ...
    padding-left: 1px;"><i class="fa fa-bars" style="padding-right:10px;"></i> BẠN CẦN BIẾT </div> 
          ...
          <?php if ($posts && $posts->num_rows > 0): ?>
                                    <?php while ($row = $posts->fetch_assoc()): ?>
                                        ...
                                        $postLink = htmlspecialchars(str_replace("?", "", strtolower("post/{$row['linkurl']}")));
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="eblog-featured-news style-two small">
                            <div class="image-area">
                                <a href="<?php echo $postLink; ?>"> <img src="<?php echo $imageSrc; ?>" alt="<?php echo $postTitle; ?>"/></a>
                            </div>
                            <div class="blog-content text-left">
                          
                              <a href="<?php echo $postLink; ?>">  <div class="heading-title ml--0 mb--10 text-start" style=" font-size: 19px;
    line-height: 27px;
    padding: 10px;"><?php echo $postTitle; ?></div></a>
