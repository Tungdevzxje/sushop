        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <div class="mb-3">
                        <label for="email" class="form-label">Email ( Vui lòng nhập đúng để nhận thông báo khi đặt hàng)</label>
                    ...
                    <div class="mb-4">
                        <h5 class="text-end">Tổng tiền: <span class="text-danger"><?= number_format(getTotalPrice()); ?> đ</span></h5>
                    </div>
