...
switch ($_GET['thamso']) {
	...
	case"dangky":
		switch ($ngon_ngu_abc) {
			...
			case "tieng_anh":
				include('dangnhap_dangky/register.php');
	...
	case"dangxuat":
		switch ($ngon_ngu_abc) {
			...
			case "tieng_anh":
				include('dangnhap_dangky/logout.php');
	...
	case"lichsu_donhang":
		switch ($ngon_ngu_abc) {
			...
			case "tieng_anh":
				...
				include('lichsu_dathang/lichsu_donhang.php');
		...
		case "chitiet_tindichvuu":
			...
			switch ($ngon_ngu_abc) {
				...
				case "tieng_anh":
					...
					include('tin_dichvuu/chitiet_tindichvuu_en.php');

					break;

				default:

					include('tin_dichvuu/chitiet_tindichvuu.php');
			}
		...
		case "tin_dichvuu":
			...
			switch ($ngon_ngu_abc) {
				...
				case "tieng_anh":
					...
					include('tin_dichvuu/tin_dichvuu_en.php');
				...
				default:
					...
					include('tin_dichvuu/tin_dichvuu.php');
			}
		...
		case "tin_dichvuuct":
			...
			switch ($ngon_ngu_abc) {
				...
				case "tieng_anh":
					...
					include('tin_dichvuu/tin_dichvuuct_en.php');
				...
				default:
					...
					include('tin_dichvuu/tin_dichvuuct.php');
			}
		...
		case "tin_dichvuuctc":
			...
			switch ($ngon_ngu_abc) {
				...
				default:
					...
					include('tin_dichvuu/tin_dichvuuctc.php');
			}
	...
	case "chitiet_gioithieu":
		...
		break;
	case "chitiet_gioithieu2":

		switch ($ngon_ngu_abc) {

			case "tieng_anh":

				include('gioi_thieu/chitiet_gioithieu_en2.php');

				break;

			default:

				include('gioi_thieu/chitiet_gioithieu2.php');
		}
