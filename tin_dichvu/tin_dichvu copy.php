    ...
    <div class="text-heading text-center">
        <div class="container">
            <div style="padding:10px;">
                <h2 style="font-weight: bold; color:#ff0000; padding-top: 100px;">PHỐI MÀU</h2>
                <div style="font-weight: bold;"><a href="trangchu">Trang chủ </a> &nbsp;/&nbsp; Phối Màu </div>
            </div>
        </div>
    </div>
</section>
<!-- END SECTION HEADINGS -->
<h2 style="font-size:0px; margin: 0px; height:0px; color:#fff; margin: 0px; padding: 0px;"><a>xây nhà lắp ghép giá rẻ
        Quảng Nam</a></h2>
<h1 style="font-size:0px; margin: 0px; height:0px; color:#fff; margin: 0px; padding: 0px;"><a>nhà lắp ghép tiết kiệm
        điện năng</a></h1>
<h3 style="font-size:0px; margin: 0px; height:0px; color:#fff; margin: 0px; padding: 0px;"><a>nhà lắp ghép làm chòi nghỉ
        dưỡng</a></h3>
<h3 style="font-size:0px; margin: 0px; height:0px; color:#fff; margin: 0px; padding: 0px;"><a>nhà lắp ghép cho quán ăn
        nhanh</a></h3>
<h3 style="font-size:0px; margin: 0px; height:0px; color:#fff; margin: 0px; padding: 0px;"><a>nhà lắp ghép cho công
        nhân</a></h3>
<h3 style="font-size:0px; margin: 0px; height:0px; color:#fff; margin: 0px; padding: 0px;"><a>nhà lắp ghép tối ưu diện
        tích</a>
</h3>
<h3 style="font-size:0px; margin: 0px; height:0px; color:#fff; margin: 0px; padding: 0px;"><a>nhà lắp ghép cách nhiệt
        tốt</a></h3>
<!-- START SECTION BLOG -->
