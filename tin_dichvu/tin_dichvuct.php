            ...
            <div class="container">
                <div class="news-wrap">
                    <div class="row">
                            ...
                            // Prepare SQL queries
                            $stmt = $link->prepare("SELECT COUNT(*) FROM tin_dichvu WHERE thuocloai = ?");
                            ...
                            $stmt = $link->prepare("SELECT * FROM tin_dichvu WHERE thuocloai = ? ORDER BY id DESC LIMIT ?, ?");
